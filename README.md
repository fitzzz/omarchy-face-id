...
```bash
chmod +x dist/Omarchy_Face_ID-0.5.0-x86_64.AppImage
APPIMAGE_EXTRACT_AND_RUN=1 ./dist/Omarchy_Face_ID-0.5.0-x86_64.AppImage
```
...
```bash
APPIMAGE_EXTRACT_AND_RUN=1 ./dist/Omarchy_Face_ID-0.5.0-x86_64.AppImage --uninstall
```
